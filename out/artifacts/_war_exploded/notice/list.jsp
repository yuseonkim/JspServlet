...
<div id="body">
    <div class="content-container clearfix">
        ...
        <main class="main">
            ...
            <c:set var="stratNum" value="${page - page%5 + 1}"/>
            <c:set var="endNum" value="${page - page%5 + 5}"/>
            <c:set var="endPage" value="${20}"/>

            <div class="indexer margin-top align-right">
                <h3 class="hidden">현재 페이지</h3>
                <div><span class="text-orange text-strong"></span> / 1 page</div>
            </div>
            ...
            <div class="margin-top align-center pager">
                ...
                <div>
                    ...
                    <c:if test="${startNum != 1 }">
                        <span class="btn btn-prev"><a href="?p=${startNum-5}"></a></span>
                    </c:if>
                </div>
                <ul class="-list- center">
                    <c:forEach var="i" begin="${stratNum}" end="${endNum}">
                    <li><a class="-text- ${i == page ? 'orange bold':'gray bold'}" href="?p=${i}">${i}</a></li>
                    </c:forEach>
                </ul>
                <div>
